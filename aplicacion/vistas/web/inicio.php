...
<?php 
// Usamos __DIR__ para subir niveles y encontrar los componentes
...
<section class="hero-slider">
    ...
    <div class="slide active">
        <img src="web/imagenes/1.png" class="slide-img">
    ...
    <!-- SLIDE 2 -->
    <div class="slide">
        <img src="web/imagenes/2.png" class="slide-img">
    ...
    <!-- SLIDE 3 -->
    <div class="slide">
        <img src="web/imagenes/3.png" class="slide-img">
...
<?php 
// Corregimos la ruta del footer (asegúrate que la carpeta sea 'web' o 'publico')
